...
Deployment
The website is deployed using GitHub Pages and also on Netlify. The source code is hosted on GitHub, and the website is automatically built and deployed whenever changes are pushed to the main branch.
